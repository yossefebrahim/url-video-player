...
class CastContextMethodChannel : FlutterPlugin, MethodChannel.MethodCallHandler {
    ...
    companion object {
        /**
         * The receiver application id last passed to [setSharedInstance].
         * Exposed so route selection can build the exact Cast control category
         * and prefer the real Cast route over a phantom user route.
         */
        @Volatile
    ...
    private fun setSharedInstance(arguments: Any?, result: MethodChannel.Result) {
        try {
            ...
            val receiverAppId = map["appId"] as String
            appId = receiverAppId
            optionsBuilder.setReceiverApplicationId(receiverAppId)
